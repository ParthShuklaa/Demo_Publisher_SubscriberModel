...
namespace Demo_Publisher_SubscriberModel
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            reader1.SubscribeToTopic("Sports");
            reader2.SubscribeToTopic("Politics");
            newsAgency.Subscribe(reader1);
            newsAgency.Subscribe(reader2);
            newsAgency.Publish("Sports", "New football season starts!");
            newsAgency.Publish("Politics", "Elections coming up!");
            // Output:
            // Alice received article: New football season starts!
            // Bob received article: Elections coming up!
        }
    }
    //NewsAgency class acts as the publisher
    ...
    //Reader class acts as the subscriber
    public class Reader
    {
        private string name;
        ...
        // For demonstration purposes, we can create instances of NewsAgency and Reader, subscribe readers to topics, and publish articles.
